...
plt.title(f'Event Percentile Rank Correlation + CH2 Heat Map (n = {len(Results["personId"].unique())})')
plt.savefig("queries/correlation_wca/correlate_figs/correlation_ch2.pdf")
plt.show()
